...
export default defineComponent({
  ...
  setup() {
    ...
    const lat = computed(() => storeLK.laporan.kejadian.lat)
    const lng = computed(() => storeLK.laporan.kejadian.lng)
    ...
    return {
      ...
      onSelected(value) {
        storeLK.laporan.kejadian.lat = value.y
        storeLK.laporan.kejadian.lng = value.x
      },
      addMarker(e) {
        storeLK.laporan.kejadian.lat = e.latlng.lat
        storeLK.laporan.kejadian.lng = e.latlng.lng
