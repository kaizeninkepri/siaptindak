          ...
          <q-td width="200px">
            <div class="q-gutter-sm">
              <q-btn label="Rincian Data" icon="next_plan" class="radius5" color="indigo-4" unelevated
                :to="{ name: 'laporan-informasi-detail', params: { v: props.row.laporan_kejadian_id } }" />
