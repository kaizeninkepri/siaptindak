...
import { useLaporanInformasiStore } from "stores/spt";
...
const storeLK = useLaporanInformasiStore();
...
export default defineComponent({
  ...
  setup() {
    ...
    onBeforeMount(() => {
      ...
      storeRef.header.title = "Formulir Laporan Informasi";
          ...
          <q-card class="radius10">
            ...
            <q-card-section>
              <div class="row q-col-gutter-sm">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                  <q-select label="Dasar Laporan Kejadian" dense filled :options="['SPT']" v-model="dasarLaporan" />
                </div>
            ...
            <div class="q-pa-md bg-grey-3 radius10">
                ...
                <div class="row q-col-gutter-sm">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <q-select label="Cara Mendapatkan Informasi" dense filled
                      :options="['WAWANCARA', 'PENELITIAN', 'ELECTING', 'PENGAMATAN']" v-model="lk.tindakan.tindakan" />
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="row q-col-gutter-sm q-mt-sm">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <q-editor dense filled v-model="lk.deskripsi" placeholder="Analisa Singkat" />
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <q-editor dense filled v-model="lk.operandi" placeholder="Prediksi" />
                </div>
              </div>
            </q-card-section>
            <q-card-section class="bg-teal-1">
              <p class="q-mb-sm text-caption text-weight-bold">NARASUMBER</p>
              <div v-for="(p, pIndex) in lk.person" :key="pIndex">
                <div class="row q-col-gutter-md q-mb-md">
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <q-select dense filled v-model="p.kategori" label="Status" :options="['NARASUMBER']" />
                  </div>
              ...
              <div class="q-gutter-sm q-mt-sm">
                <q-btn label="Tambah Narasumber" outline color="teal-5" class="radius5" @click="addPersonKejadian" />
              </div>
            </q-card-section>
            <q-card-section>
              <formMapping />
