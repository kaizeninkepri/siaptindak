...
export default defineComponent({
  name: "spt-form-dasar",
  setup() {
    const form = storeLK.laporan.kejadian
  ...
  <div>
    <div class="row q-col-gutter-sm items-center">
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
        <p class="q-mb-xs text-grey-9">PASAL PELANGGARAN</p>
      </div>
    ...
    <div class="q-gutter-sm q-mt-md">
      <q-item tag="label" v-ripple v-for="(d, dIndex) in dasar" :key="dIndex">
        <q-item-section avatar top>
          <q-checkbox class="q-ma-none" v-model="form.pasal_pelanggaran" :val="d.undang_id" />
        </q-item-section>
        <q-item-section top>
