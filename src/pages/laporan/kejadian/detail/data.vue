...
export default defineComponent({
  ...
  components: {
    ...
    bbPage: defineAsyncComponent(() => import("./bb.vue")),
    LMap,
    LTileLayer,
    LControl,
    LMarker
...
<template>
  <div>
    <q-item>
      <q-item-section>
        <div class="text-left">
          <q-btn icon="arrow_back" color="black" flat :to="{ name: 'laporan', query: { p: 1 } }"
    ...
    <q-card class="radius10">
      <q-card-section>
        <div class="row items-center">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <p class="text-h6 q-mb-none text-weight-bold text-grey-8">RINCIAN LAPORAN KEJADIAN</p>
            <p class="text-caption q-mb-none text-weight-bold text-grey-8">LAPORAN KEJADIAN OLEH PETUGAS</p>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <q-item>
      ...
      <q-card-section class="bg-teal-2">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
            <span class="text-caption text-gery-9">Tanggal dan Jam Kejadian</span>
          ...
          <q-card-section>
            <div class="row q-col-gutter-sm">
              <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <p class="text-caption q-mb-none">Deskripsi Kejadian</p>
                <p class="text-subtitle1">
                  <span v-html="lk.deskripsi"></span>
                </p>
              </div>
              <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <p class="text-caption q-mb-none">Modus Operandi</p>
                <span v-html="lk.operandi"></span>
              </div>
              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                <p class="text-weight-bold q-mb-sm">Tindakan / solusi</p>
                <table class="tindakanTable">
                  <thead>
                    <tr>
                      <th>NO</th>
                      <th>NAMA TINDAKAN</th>
                  ...
                  <tbody>
                    <tr v-for="(t, tIndex) in lk.tindakan" :key="tIndex">
                      <td>{{ tIndex + 1 }}</td>
                      <td>{{ t.tindakan }}</td>
                      <td>{{ t.masaTenggang }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <q-card-section class="q-pa-none q-mt-md">
        <bbPage :laporanKejadianId="lk.laporan_kejadian_id" />
      </q-card-section>
    </q-card>
