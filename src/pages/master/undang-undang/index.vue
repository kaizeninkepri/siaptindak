...
const storeUndang = useUndangStore();
export default defineComponent({
  name: 'master-undang-undang-table',
  components: {
...
<template>
  <div>
    <q-table :rows="table.data" :loading="table.isLoading" :columns="columns" row-key="name">
      <template v-slot:top>
        <div>
          <p class="text-weight-bold text-uppercase q-ma-none">Daftar Undang-Undang</p>
          ...
          <q-td width="200px">
            <div class="q-gutter-sm">
              ...
              <q-btn icon="delete" class="radius5" color="red-5" unelevated
                @click="storeUndang.dataDelete(props.row.undang_id)" />
      ...
      <q-card style="width: 700px; max-width: 80vw;" class="radius10">
        <q-item>
          ...
          <q-item-section side class="text-black">
            <q-item-label>UNDANG-UNDANG</q-item-label>
