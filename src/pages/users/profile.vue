  ...
  <div>
    <q-form ref="myForm">
      <div class="row">
        ...
        <div class="col-lg-9 bg-grey-3 col-md-3 col-xs-12 col-sm-12 radius10">
          <div class="q-pa-md">
            <q-btn icon="logout" flat color="red-5" label="keluar Aplikasi" @click="storeRef.dialog.logout = true"
